...
void printdata(void) {
	...
	Serial.print(",Alt: ");
	Serial.print(press_alt/100);  // Original floating point full solution in meters
	Serial.print (",");
#endif
#if USE_BAROMETER == 2
        BMP085.Read();    // Read I2C
	Serial.print("Temp:");
	Serial.print(BMP085.Temp/10.0);      // Convert into degrees C

	Serial.print(",Pressure: ");
	Serial.print(BMP085.Press);
	alti();
	Serial.print(",Alt: ");
	Serial.print(press_alt/100);  // Original floating point full solution in meters
	Serial.print (",");
