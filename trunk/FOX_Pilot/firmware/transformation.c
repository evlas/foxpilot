...
void turn_xy_plane(const float_vect3* vector, const float yaw, float_vect3* result) {
	//turn clockwise
...
void navi2body_xy_plane(const float_vect3* vector, const float yaw, float_vect3* result) {
	turn_xy_plane(vector, yaw, result);
	//	result->x = cos(yaw) * vector->x + sin(yaw) * vector->y;
	//	result->y = -sin(yaw) * vector->x + cos(yaw) * vector->y;
	//	result->z = vector->z; //leave direction normal to xy-plane untouched
}
void body2navi_xy_plane(const float_vect3* vector, const float yaw, float_vect3* result) {
	turn_xy_plane(vector, -yaw, result);
	//	result->x = cos(yaw) * vector->x + -sin(yaw) * vector->y;
	//	result->y = sin(yaw) * vector->x + cos(yaw) * vector->y;
	//	result->z = vector->z; //leave direction normal to xy-plane untouched
...
void navi2body(const float_vect3* vector, const float_vect3* angles, float_vect3* result) {
	//TODO implement this
}
//Laurens
void body2navi(const float_vect3* vector, const float_vect3* angles, float_vect3* result) {
